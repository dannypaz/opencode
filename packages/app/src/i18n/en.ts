export const dict = {
  ...
  "dialog.server.cloud.sessionName": "Cloud session",
  "dialog.server.cloud.button": "New cloud session",
  "dialog.server.cloud.starting": "Starting cloud session...",
  "dialog.server.cloud.configureTitle": "Cloud control plane",
  "dialog.server.cloud.apiKey": "API key",
  "dialog.server.cloud.provisionUrl": "Provision URL",
  "dialog.server.cloud.deprovisionUrl": "Deprovision URL",
  "dialog.server.cloud.save": "Save",
  "dialog.server.cloud.error": "Could not start cloud session",
